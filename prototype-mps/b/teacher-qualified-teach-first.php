            ...
            <div id="main-content-left-only" class="large-8 cell">
                ...
                <form action="teacher-location-eligibility.php" method="POST" role="form" data-abide novalidate onsubmit="get_action(this);">
                    ...
                    <div data-abide-error class="alert callout" style="display: none;">
                        ...
                        <p><a href="#example1Error1">Please enter the subject specialised in during your Teach First initial teacher training?</a></p>
                    </div>
                        ...
                        <fieldset class="govuk-fieldset" role="group" aria-describedby="bank-hint">
                            ...
                            <legend class="govuk-fieldset__legend govuk-fieldset__legend--xl">
                                <h1 class="govuk-fieldset__heading">
                                    What subject did you specialise in during your Teach First initial teacher training?
                                </h1>
                            </legend>
                            ...
                            <div class="govuk-form-group">
                                ...
                                <div class="govuk-radios">
                                    ...
                                    <div class="govuk-radios__item">
                                        ...
                                        <input class="govuk-radios__input" name="x" type="radio" value="teacher-qualified-teach-first-ske.php" id="x">
